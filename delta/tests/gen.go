...
//go:generate sh -c "protoc --dart_out=../../test/pb --go_out=. --go_opt=paths=source_relative --proto_path=. --proto_path=./../../proto/ *.proto"
...
//go:generate sh -c "go run ./../../protodgen/main.go -in=. -go-root=. -dart-root=../../test/pb -dart-pkg=protod/test/pb -dart-pkg-rel"
