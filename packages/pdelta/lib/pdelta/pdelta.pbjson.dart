...
const Op$json = const {
  ...
  '2': const [
    ...
    const {'1': 'object', '3': 7, '4': 1, '5': 11, '6': '.pdelta.Object', '9': 0, '10': 'object'},
...
const Quill$json = const {
  ...
  '2': const [
    ...
    const {'1': 'attributes', '3': 4, '4': 1, '5': 11, '6': '.pdelta.Object', '10': 'attributes'},
  ],
  '8': const [
    const {'1': 'v'},
  ],
...
const Object$json = const {
  '1': 'Object',
  '2': const [
    const {'1': 'scalar', '3': 1, '4': 1, '5': 11, '6': '.pdelta.Scalar', '9': 0, '10': 'scalar'},
    const {'1': 'message', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Any', '9': 0, '10': 'message'},
    const {'1': 'list', '3': 3, '4': 1, '5': 11, '6': '.pdelta.List', '9': 0, '10': 'list'},
    const {'1': 'mapBool', '3': 4, '4': 1, '5': 11, '6': '.pdelta.MapBool', '9': 0, '10': 'mapBool'},
    const {'1': 'mapInt32', '3': 5, '4': 1, '5': 11, '6': '.pdelta.MapInt32', '9': 0, '10': 'mapInt32'},
    const {'1': 'mapInt64', '3': 6, '4': 1, '5': 11, '6': '.pdelta.MapInt64', '9': 0, '10': 'mapInt64'},
    const {'1': 'mapUint32', '3': 7, '4': 1, '5': 11, '6': '.pdelta.MapUint32', '9': 0, '10': 'mapUint32'},
    const {'1': 'mapUint64', '3': 8, '4': 1, '5': 11, '6': '.pdelta.MapUint64', '9': 0, '10': 'mapUint64'},
    const {'1': 'mapString', '3': 9, '4': 1, '5': 11, '6': '.pdelta.MapString', '9': 0, '10': 'mapString'},
  ],
  '8': const [
    const {'1': 'v'},
  ],
...
const MapBool$json = const {
  '1': 'MapBool',
  '2': const [
    const {'1': 'map', '3': 1, '4': 3, '5': 11, '6': '.pdelta.MapBool.MapEntry', '10': 'map'},
  ],
...
const MapBool_MapEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.pdelta.Object', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const MapInt32$json = const {
  '1': 'MapInt32',
  '2': const [
    const {'1': 'map', '3': 1, '4': 3, '5': 11, '6': '.pdelta.MapInt32.MapEntry', '10': 'map'},
  ],
...
const MapInt64$json = const {
  '1': 'MapInt64',
  '2': const [
    const {'1': 'map', '3': 1, '4': 3, '5': 11, '6': '.pdelta.MapInt64.MapEntry', '10': 'map'},
  ],
...
const MapUint32$json = const {
  '1': 'MapUint32',
  '2': const [
    const {'1': 'map', '3': 1, '4': 3, '5': 11, '6': '.pdelta.MapUint32.MapEntry', '10': 'map'},
  ],
...
const MapUint64$json = const {
  '1': 'MapUint64',
  '2': const [
    const {'1': 'map', '3': 1, '4': 3, '5': 11, '6': '.pdelta.MapUint64.MapEntry', '10': 'map'},
  ],
...
const MapString$json = const {
  '1': 'MapString',
  '2': const [
    const {'1': 'map', '3': 1, '4': 3, '5': 11, '6': '.pdelta.MapString.MapEntry', '10': 'map'},
  ],
...
const List_$json = const {
  '1': 'List',
  '2': const [
    const {'1': 'list', '3': 1, '4': 3, '5': 11, '6': '.pdelta.Object', '10': 'list'},
  ],
};
