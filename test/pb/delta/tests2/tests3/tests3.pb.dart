...
//  source: delta/tests2/tests3/tests3.proto
//
// @dart = 2.3
...
class Pants extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pants', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tests3'), createEmptyInstance: create)
